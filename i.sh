...
sleep 1
curl --cookie cookies.txt "http://$MYDOMAIN:$MYPORT/server/installXray/v1.7.2" -X 'POST' -H 'Accept: application/json, text/plain, */*' -H 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8' -H 'X-Requested-With: XMLHttpRequest' 2>> 2.log 1>> 1.log
